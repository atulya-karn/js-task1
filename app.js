$(document).ready(function(){
	$("#nav2").append("<h6>Your Current Location is:&nbsp&nbsp&nbspAllow Location access</h6>");
				...
				success:function(data){
					...
					$.each( results, function( key, value ) {
	 				...
	 				image= value.urls.regular;
	 					...
	 					$('#img').append('<div class="col-md-6 mt-4" style="margin:auto"><div style="width: 22rem; margin:auto;"><img style="height:250px; width:350px;" src="'+ image +'"></div></div>');
